 ...
 *  
 *       Author: see
 *        $Date: 2010/04/20 15:04:13 $
 *    $Revision: 1.7 $
 *
 *  Description: M72 example for period measurement
 *                      
 *               Configuration:
 *               - period measurement
 ...
 *
 * $Log: m72_period.c,v $
 * Revision 1.7  2010/04/20 15:04:13  amorbach
 * R: Porting to MDIS5
 * M: changed according to MDIS Porting Guide 0.8
 *
 * Revision 1.6  2006/09/27 18:55:28  ts
 * changed return type of main() to int due to Compiler warnings
 *
 * Revision 1.5  2004/08/30 12:19:31  dpfeuffer
 * minor modifications for MDIS4/2004 conformity
 *
 * Revision 1.4  1999/08/06 15:07:11  Franke
 * cosmetics
 *
 * Revision 1.3  1999/08/06 10:30:18  Schoberl
 * added headers stdlib.h, string.h
 *
 * Revision 1.2  1999/08/06 09:19:21  Schoberl
 * cosmetics
 * functions static
 ...
 *
 * Revision 1.1  1998/10/23 16:31:32  see
 * Added by mcvs
 *
 *---------------------------------------------------------------------------
...
int main(int argc, char *argv[])
{
	...
	if (argc < 3 || strcmp(argv[1],"-?")==0) {
		printf("Syntax: m72_period <device> <chan>\n");
		printf("Function: M72 example for period measurement\n");
		printf("Options:\n");
	...
	/* counter mode: period measurment */
	if ((M_setstat(path, M72_CNT_MODE, M72_MODE_PERIOD)) < 0) {
	...
	do {
		/* start measurement */
		printf("start period measurement\n");
